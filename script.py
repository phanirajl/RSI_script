...
class RSI_Script(object):
    ...
    def algorithm(self, coin_symbol):
        ...
        candles = self.client.Trade.Trade_getBucketed(symbol=coin_symbol, binSize="5m", count=250, partial=True, startTime=datetime.datetime.now()-self.SELECTED_OFFSET).result()
